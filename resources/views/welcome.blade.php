...
<head>
    <title>Flower City Tutoring </title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta charset="utf-8" />
    <meta name="keywords" content="best tutoring in brampton, Flower City Tutoring, Flat Web Templates, Android Compatible web template,
    ...
    <!-- testimonials -->
    <link href="css/testimonials.css" type="text/css" rel="stylesheet" media="all">
        ...
        <div class="d-sm-flex justify-content-between">
            <h1>
                <a class="navbar-brand" href="index.html">
                    FLOWER<span>CI</span>TY<span>TU</span>TO<span>R</span>ING
                </a>
            </h1>
            ...
            <div class="container-fluid px-0">
                <div class="row">
                    ...
                    <div class="slider-info">
                        <span class="line">Our Mission</span>
                        <h3>The mission of <span>FlowerCity Tutoring</span>  is to change the trajectory of students’ lives.</h3>
                        <p class="text-white">The mission of Project Exceed is to provide personalized tutoring services
                            to help young people transform goals into achievements.</p>
        ...
        <li class="slider-img">
            <div class="container-fluid px-0">
                <div class="row">
                    ...
                    <div class="slider-info">
                        <span class="line">Vision Statement</span>
                        <h3>activities <span>improves</span> mind</h3>
                        <p class="text-white">Project Exceed is dedicated to inspiring the academic
                            achievement of the young people we serve.
                            We will understand and respond to the needs of our students, commit to providing high-quality tutoring services,
                            focus on recruiting excellent teachers, encourage the generosity of our donors,
                            and foster a culture of continuous improvement. </p>
        ...
        <li class="slider-img">
            <div class="container-fluid px-0">
                <div class="row">
                    ...
                    <div class="slider-info">
                        <span class="line">Measured Outcomes</span>
                        <h3>activities <span>improves</span> mind</h3>
                        <p class="text-white">Increased Achievement, Enrollment, Donors, and Participation. </p>
                ...
                <ul class="navbar-nav  text-center">
                    ...
                    <li class="nav-item dropdown mr-lg-3 mt-lg-0 mt-3">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item scroll" href="#stat">facts</a>
                            <a class="dropdown-item scroll" href="#team">team</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item scroll" href="#portfolio">gallery</a>
...
<section class="wthree-row  w3-about position-relative" id="about">
    <div class="container">
        <div class="about-head">
            <div class="sec-main">
                <span class="sub-line">about us</span>
                <h3 class="wthree-title">welcome to alphabet</h3>
            </div>
            <p>Donec consequat sapien ut leo cursus rhoncus. Nullam dui mi, vulputate ac metus at, semper
                varius orci.
                Nulla accumsan ac elit in congue. Class aptent taciti sociosqu ad litora torquent.</p>
            <div class="ab-btm">
                <h4>presenting you activities</h4>
                ...
                <a class="btn bg-theme mt-4 w3_pvt-link-bnr scroll bg-theme3 text-white" href="#services" role="button">Know
                    More</a>
            </div>
        </div>
    </div>
    <div class="abt-pos">
        ...
        <div class="contcat-form">
            <form action="#" method="post" class="register-wthree">
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        <button type="submit" class="btn  btn-block w-100 font-weight-bold text-capitalize bg-theme1 text-white">Submit
                            request</button>
                    </div>
                </div>
            </form>
...
<!-- //about -->
<!-- why us -->
<section class="why-sec" id="services">
    <div class="container py-lg-3">
        <div class="row">
            <div class="col-lg-6 bg-img1 order-lg-0 order-1 mt-lg-0 mt-4">
            </div>
            <div class="offset-lg-1 col-lg-5 order-lg-1 order-0 ">
                <div class="sec-main">
                    <span class="sub-line">why us</span>
                    <h3 class="wthree-title">experience yourself</h3>
                </div>
                <ul class="list-group mt-3 why-list">
                    <li class="list-group-item border-0">
                        <span class="num mr-3">01</span>Cras justo odio</li>
                    <li class="list-group-item border-0">
                        <span class="num mr-3">02</span>Dapibus ac facilisis in</li>
                    <li class="list-group-item border-0">
                        <span class="num mr-3">03</span>Morbi leo risus</li>
                    <li class="list-group-item border-0">
                        <span class="num mr-3">04</span>Porta ac consectetur ac</li>
                    <li class="list-group-item border-0">
                        <span class="num mr-3">05</span>Vestibulum at eros</li>
                </ul>
            </div>
        </div>
    </div>
...
<!-- //why us -->
<section class="services-w3sec">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 my-lg-0 my-sm-5 my-4">
                <div class="w3ls-servgrid card service-active">
                    <div class="card-header">
                        <span class="sub-line">01</span>
                        <h4 class="serv-title">
                            service
                        </h4>
                    </div>
                    <div class="card-block">
                        <p class="card-title servgrid-title">
                            Pellentesque in ipsum id orci porta dapibus. Nulla quis lorem ut libero malesuada
                            feugiat praesent sapien massa.
                        </p>
                        <a href="#portfolio" class="text-capitalize servgrid_link btn scroll">read more</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
            ...
            <div class="col-lg-4 my-lg-0 my-4 pl-lg-0">
                <div class="w3ls-servgrid card">
                    <div class="card-header">
                        <span class="sub-line">03</span>
                        <h4 class="serv-title">
                            service
                        </h4>
                    </div>
...
<!-- //services -->
<!-- portfolio -->
<div class="portfolio-wthree py-lg-5" id="portfolio">
    <div class="container pt-md-5 pt-4">
        <div class="sec-main">
            <span class="sub-line">look out</span>
                ...
                <li class="col-lg-4  col-md-6">
                    <div class="img-grid">
                        ...
                        <div class="port-desc text-center">
                            ...
                            <h6 class="main-title-w3pvt text-center">portfolio-Description</h6>
                            <p>
...
<!-- //portfolio -->
<!-- stats -->
<section class="w3_pvt_stats py-md-5 py-4" id="stat">
    <div class="container">
        <div class="py-lg-5 w3-abbottom ">
            <div class="sec-main">
                <span class="sub-line">know more</span>
                <h3 class="wthree-title">interesting facts</h3>
            </div>
            <p class="text-white stat-txt">Donec consequat sapien ut leo cursus rhoncus. Nullam dui mi,
                vulputate
                ac metus at, semper
                varius orci.
                Nulla accumsan ac elit in congue. Class aptent taciti sociosqu ad litora torquent.</p>
            <div class="row py-md-5  py-4">
                <div class="counter col-lg-3 col-6">
                    ...
                    <p class="count-text text-white">Successful Kids</p>
                </div>

                <div class="counter col-lg-3 col-6">
                    <div class="timer count-title count-number mt-2 text-white" data-to="1271" data-speed="1500"></div>
                    <p class="count-text text-white">Happy Parents</p>
                </div>
                <div class="counter col-lg-3 col-6 mt-lg-0 mt-4">
                    ...
                    <p class="count-text text-white">Qualified Teachers</p>
                </div>
                <div class="counter col-lg-3 col-6 mt-lg-0 mt-4">
                    <div class="timer count-title count-number mt-2 text-white" data-to="27" data-speed="1500"></div>
                    <p class="count-text text-white">Award Won</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="team_wthree py-4" id="team">
    <div class="container py-lg-5">
        <div class="sec-main">
            <span class="sub-line">team work</span>
            <h3 class="wthree-title">our mentors</h3>
        </div>
...
<!-- //team -->
<!-- blog -->
<section class="blog_w3ls pb-lg-5" id="posts">
    <div class="container pb-sm-5 pb-4">
        <div class="sec-main">
            <span class="sub-line">know more</span>
            <h3 class="wthree-title">latest blog posts</h3>
        </div>
                    ...
                    <div class="card-header p-0 position-relative">
                        <a href="#exampleModal3" data-toggle="modal" aria-pressed="false" data-target="#exampleModal3"
                           role="button">
                            ...
                            <span class="fa fa-user post-icon bg-theme2" aria-hidden="true"></span>
                    ...
                    <div class="card-header p-0  position-relative">
                        <a href="#exampleModal4" data-toggle="modal" aria-pressed="false" data-target="#exampleModal4"
                           role="button">
                            ...
                            <span class="fa fa-user post-icon bg-theme3" aria-hidden="true"></span>
                        </a>
                    </div>
                    <div class="card-body">
                        <h5 class="blog-title card-title font-weight-bold">
...
<div class="testimonials-wthree py-lg-5 py-4 text-center" id="testimonials">
    <div class="container">
        <div class="sec-main text-left">
            <span class="sub-line text-white">feedback</span>
            <h3 class="wthree-title text-theme2">what happy parents say?</h3>
        </div>
        <div class="row">
                                ...
                                <div class="carousel-caption">
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 col-sm-8 mt-sm-0 mt-4">
                                            <h3>Gives me hope</h3>
                                            <p class="my-3">Cras justo odio, dapibus ac facilisis in, egestas eget
                                                quam. Donec
                                                id elit non mi porta gravida at eget metus. Nullam id dolor id nibh
                                                ultricies vehicula ut id elit.</p>
                                            <p class="text-theme">- Yayo Dudemous</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="contact-wthree pt-lg-5" id="contact">
    <div class="container py-sm-5 py-4">
        <div class="sec-main">
            <span class="sub-line">get in touch</span>
            <h3 class="wthree-title">contact us</h3>
        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-md-4 d-flex mt-4">
                                        <button type="submit" class="btn btn-w3_pvt btn-block w-100 text-white font-weight-bold text-uppercase bg-theme1">Send
                                            message</button>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="container-fluid">
        <div class="row p-sm-4 px-3 py-5">
            <div class="col-lg-4 col-md-6 footer-top mt-md-0 mt-sm-5">
                <h2>
                    <a class="navbar-brand" href="index.html">
                        Al<span>p</span>h<span>a</span>b<span>e</span>t
                    </a>
                </h2>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-6 text-lg-right mt-lg-0 mt-4">
                <p>© 2018 Alphabet. All rights reserved | Design by
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-theme">
                <h5 class="modal-title" id="exampleModalLabel2">This is a standard post.</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel3"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-theme">
                <h5 class="modal-title" id="exampleModalLabel3">This is a standard post.</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="exampleModal4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel4"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-theme">
                <h5 class="modal-title" id="exampleModalLabel4">This is a standard post.</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
